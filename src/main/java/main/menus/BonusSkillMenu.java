...
public class BonusSkillMenu {
    ...
    public static void open(Player player) {
        ...
        flammeMeta.setLore(Arrays.asList("§7Applique un effet de faiblesse aux ennemis.", "§bCoût : 60 Mana"));
        ...
        vagueMeta.setLore(Arrays.asList("§7Inflige des dégâts dans une zone.", "§bCoût : 50 Mana"));
        ...
        tempeteMeta.setLore(Arrays.asList("§7Applique un effet de lenteur aux ennemis.", "§bCoût : 70 Mana"));
